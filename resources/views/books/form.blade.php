...
@endif
<form method="POST" action="@if(!empty($book)) {{route($prefix.'.books.update', [$book])}} @else {{route($prefix.'.books.store')}} @endif" enctype="multipart/form-data">
    @if(!empty($book))
        {{ method_field('PUT') }}
    @endif
    @csrf
    ...
    <div class="form-row">
        <div class="form-group col-md-5">
            ...
            <select multiple id="authors" name="authorIds[]" class="form-control js-chosen js-options-select-authors" data-placeholder="Choose authors...">
        ...
        <div class="form-group col-md-5">
            ...
            <select multiple id="genres" name="genreIds[]" class="form-control js-chosen js-options-select-genres" data-placeholder="Choose genres...">
